 ...
 * @see MPU9250_DEFAULT_SS_PIN
 */
MPU9250::MPU9250() {
    devAddr = MPU9250_DEFAULT_SS_PIN;
}
...
uint8_t MPU9250::getRate() {
    SPIdev::readByte(devAddr, MPU9250_RA_SMPLRT_DIV, buffer);
    return buffer[0];
}
...
void MPU9250::setRate(uint8_t rate) {
    SPIdev::writeByte(devAddr, MPU9250_RA_SMPLRT_DIV, rate);
}
...
uint8_t MPU9250::getExternalFrameSync() {
    SPIdev::readBits(devAddr, MPU9250_RA_CONFIG, MPU9250_CFG_EXT_SYNC_SET_BIT, MPU9250_CFG_EXT_SYNC_SET_LENGTH, buffer);
    return buffer[0];
}
...
uint8_t MPU9250::getDLPFMode() {
    SPIdev::readBits(devAddr, MPU9250_RA_CONFIG, MPU9250_CFG_DLPF_CFG_BIT, MPU9250_CFG_DLPF_CFG_LENGTH, buffer);
    return buffer[0];
}
...
void MPU9250::setDLPFMode(uint8_t mode) {
    SPIdev::writeBits(devAddr, MPU9250_RA_CONFIG, MPU9250_CFG_DLPF_CFG_BIT, MPU9250_CFG_DLPF_CFG_LENGTH, mode);
}
...
uint8_t MPU9250::getFullScaleGyroRange() {
    SPIdev::readBits(devAddr, MPU9250_RA_GYRO_CONFIG, MPU9250_GCONFIG_FS_SEL_BIT, MPU9250_GCONFIG_FS_SEL_LENGTH, buffer);
    return buffer[0];
}
...
void MPU9250::setFullScaleGyroRange(uint8_t range) {
    SPIdev::writeBits(devAddr, MPU9250_RA_GYRO_CONFIG, MPU9250_GCONFIG_FS_SEL_BIT, MPU9250_GCONFIG_FS_SEL_LENGTH, range);
}
...
bool MPU9250::getAccelXSelfTest() {
    SPIdev::readBit(devAddr, MPU9250_RA_ACCEL_CONFIG, MPU9250_ACONFIG_XA_ST_BIT, buffer);
    return buffer[0];
}
/** Get self-test enabled setting for accelerometer X axis.
...
void MPU9250::setAccelXSelfTest(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_ACCEL_CONFIG, MPU9250_ACONFIG_XA_ST_BIT, enabled);
}
...
bool MPU9250::getAccelYSelfTest() {
    SPIdev::readBit(devAddr, MPU9250_RA_ACCEL_CONFIG, MPU9250_ACONFIG_YA_ST_BIT, buffer);
    return buffer[0];
}
/** Get self-test enabled value for accelerometer Y axis.
 * @param enabled Self-test enabled value
...
void MPU9250::setAccelYSelfTest(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_ACCEL_CONFIG, MPU9250_ACONFIG_YA_ST_BIT, enabled);
}
...
bool MPU9250::getAccelZSelfTest() {
    SPIdev::readBit(devAddr, MPU9250_RA_ACCEL_CONFIG, MPU9250_ACONFIG_ZA_ST_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setAccelZSelfTest(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_ACCEL_CONFIG, MPU9250_ACONFIG_ZA_ST_BIT, enabled);
}
...
uint8_t MPU9250::getFullScaleAccelRange() {
    SPIdev::readBits(devAddr, MPU9250_RA_ACCEL_CONFIG, MPU9250_ACONFIG_AFS_SEL_BIT, MPU9250_ACONFIG_AFS_SEL_LENGTH, buffer);
    return buffer[0];
}
...
bool MPU9250::getTempFIFOEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_FIFO_EN, MPU9250_TEMP_FIFO_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setTempFIFOEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_FIFO_EN, MPU9250_TEMP_FIFO_EN_BIT, enabled);
}
...
bool MPU9250::getXGyroFIFOEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_FIFO_EN, MPU9250_XG_FIFO_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setXGyroFIFOEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_FIFO_EN, MPU9250_XG_FIFO_EN_BIT, enabled);
}
...
bool MPU9250::getYGyroFIFOEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_FIFO_EN, MPU9250_YG_FIFO_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setYGyroFIFOEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_FIFO_EN, MPU9250_YG_FIFO_EN_BIT, enabled);
}
...
bool MPU9250::getZGyroFIFOEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_FIFO_EN, MPU9250_ZG_FIFO_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setZGyroFIFOEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_FIFO_EN, MPU9250_ZG_FIFO_EN_BIT, enabled);
}
...
bool MPU9250::getAccelFIFOEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_FIFO_EN, MPU9250_ACCEL_FIFO_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setAccelFIFOEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_FIFO_EN, MPU9250_ACCEL_FIFO_EN_BIT, enabled);
}
...
bool MPU9250::getSlave2FIFOEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_FIFO_EN, MPU9250_SLV2_FIFO_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setSlave2FIFOEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_FIFO_EN, MPU9250_SLV2_FIFO_EN_BIT, enabled);
}
...
bool MPU9250::getSlave1FIFOEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_FIFO_EN, MPU9250_SLV1_FIFO_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setSlave1FIFOEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_FIFO_EN, MPU9250_SLV1_FIFO_EN_BIT, enabled);
}
...
bool MPU9250::getSlave0FIFOEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_FIFO_EN, MPU9250_SLV0_FIFO_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setSlave0FIFOEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_FIFO_EN, MPU9250_SLV0_FIFO_EN_BIT, enabled);
}
 ...
 * MPU-9250's bus arbitration detection logic is turned on, enabling it to
...
bool MPU9250::getMultiMasterEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_MST_CTRL, MPU9250_MULT_MST_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setMultiMasterEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_I2C_MST_CTRL, MPU9250_MULT_MST_EN_BIT, enabled);
}
...
bool MPU9250::getWaitForExternalSensorEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_MST_CTRL, MPU9250_WAIT_FOR_ES_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setWaitForExternalSensorEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_I2C_MST_CTRL, MPU9250_WAIT_FOR_ES_BIT, enabled);
}
...
bool MPU9250::getSlave3FIFOEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_MST_CTRL, MPU9250_SLV_3_FIFO_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setSlave3FIFOEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_I2C_MST_CTRL, MPU9250_SLV_3_FIFO_EN_BIT, enabled);
}
...
bool MPU9250::getSlaveReadWriteTransitionEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_MST_CTRL, MPU9250_I2C_MST_P_NSR_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setSlaveReadWriteTransitionEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_I2C_MST_CTRL, MPU9250_I2C_MST_P_NSR_BIT, enabled);
}
...
uint8_t MPU9250::getMasterClockSpeed() {
    SPIdev::readBits(devAddr, MPU9250_RA_I2C_MST_CTRL, MPU9250_I2C_MST_CLK_BIT, MPU9250_I2C_MST_CLK_LENGTH, buffer);
    return buffer[0];
}
...
void MPU9250::setMasterClockSpeed(uint8_t speed) {
    SPIdev::writeBits(devAddr, MPU9250_RA_I2C_MST_CTRL, MPU9250_I2C_MST_CLK_BIT, MPU9250_I2C_MST_CLK_LENGTH, speed);
}
...
uint8_t MPU9250::getSlaveAddress(uint8_t num) {
    if (num > 3) return 0;
    SPIdev::readByte(devAddr, MPU9250_RA_I2C_SLV0_ADDR + num*3, buffer);
    return buffer[0];
}
...
void MPU9250::setSlaveAddress(uint8_t num, uint8_t address) {
    if (num > 3) return;
    SPIdev::writeByte(devAddr, MPU9250_RA_I2C_SLV0_ADDR + num*3, address);
}
...
uint8_t MPU9250::getSlaveRegister(uint8_t num) {
    if (num > 3) return 0;
    SPIdev::readByte(devAddr, MPU9250_RA_I2C_SLV0_REG + num*3, buffer);
    return buffer[0];
}
...
void MPU9250::setSlaveRegister(uint8_t num, uint8_t reg) {
    if (num > 3) return;
    SPIdev::writeByte(devAddr, MPU9250_RA_I2C_SLV0_REG + num*3, reg);
}
...
bool MPU9250::getSlaveEnabled(uint8_t num) {
    if (num > 3) return 0;
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_SLV0_CTRL + num*3, MPU9250_I2C_SLV_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setSlaveEnabled(uint8_t num, bool enabled) {
    if (num > 3) return;
    SPIdev::writeBit(devAddr, MPU9250_RA_I2C_SLV0_CTRL + num*3, MPU9250_I2C_SLV_EN_BIT, enabled);
}
...
bool MPU9250::getSlaveWordByteSwap(uint8_t num) {
    if (num > 3) return 0;
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_SLV0_CTRL + num*3, MPU9250_I2C_SLV_BYTE_SW_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setSlaveWordByteSwap(uint8_t num, bool enabled) {
    if (num > 3) return;
    SPIdev::writeBit(devAddr, MPU9250_RA_I2C_SLV0_CTRL + num*3, MPU9250_I2C_SLV_BYTE_SW_BIT, enabled);
}
...
bool MPU9250::getSlaveWriteMode(uint8_t num) {
    if (num > 3) return 0;
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_SLV0_CTRL + num*3, MPU9250_I2C_SLV_REG_DIS_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setSlaveWriteMode(uint8_t num, bool mode) {
    if (num > 3) return;
    SPIdev::writeBit(devAddr, MPU9250_RA_I2C_SLV0_CTRL + num*3, MPU9250_I2C_SLV_REG_DIS_BIT, mode);
}
...
bool MPU9250::getSlaveWordGroupOffset(uint8_t num) {
    if (num > 3) return 0;
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_SLV0_CTRL + num*3, MPU9250_I2C_SLV_GRP_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setSlaveWordGroupOffset(uint8_t num, bool enabled) {
    if (num > 3) return;
    SPIdev::writeBit(devAddr, MPU9250_RA_I2C_SLV0_CTRL + num*3, MPU9250_I2C_SLV_GRP_BIT, enabled);
}
...
uint8_t MPU9250::getSlaveDataLength(uint8_t num) {
    if (num > 3) return 0;
    SPIdev::readBits(devAddr, MPU9250_RA_I2C_SLV0_CTRL + num*3, MPU9250_I2C_SLV_LEN_BIT, MPU9250_I2C_SLV_LEN_LENGTH, buffer);
    return buffer[0];
}
...
void MPU9250::setSlaveDataLength(uint8_t num, uint8_t length) {
    if (num > 3) return;
    SPIdev::writeBits(devAddr, MPU9250_RA_I2C_SLV0_CTRL + num*3, MPU9250_I2C_SLV_LEN_BIT, MPU9250_I2C_SLV_LEN_LENGTH, length);
}
...
uint8_t MPU9250::getSlave4Address() {
    SPIdev::readByte(devAddr, MPU9250_RA_I2C_SLV4_ADDR, buffer);
    return buffer[0];
}
...
void MPU9250::setSlave4Address(uint8_t address) {
    SPIdev::writeByte(devAddr, MPU9250_RA_I2C_SLV4_ADDR, address);
}
...
uint8_t MPU9250::getSlave4Register() {
    SPIdev::readByte(devAddr, MPU9250_RA_I2C_SLV4_REG, buffer);
    return buffer[0];
}
...
void MPU9250::setSlave4Register(uint8_t reg) {
    SPIdev::writeByte(devAddr, MPU9250_RA_I2C_SLV4_REG, reg);
}
...
void MPU9250::setSlave4OutputByte(uint8_t data) {
    SPIdev::writeByte(devAddr, MPU9250_RA_I2C_SLV4_DO, data);
}
...
bool MPU9250::getSlave4Enabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_SLV4_CTRL, MPU9250_I2C_SLV4_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setSlave4Enabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_I2C_SLV4_CTRL, MPU9250_I2C_SLV4_EN_BIT, enabled);
}
...
bool MPU9250::getSlave4InterruptEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_SLV4_CTRL, MPU9250_I2C_SLV4_INT_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setSlave4InterruptEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_I2C_SLV4_CTRL, MPU9250_I2C_SLV4_INT_EN_BIT, enabled);
}
...
bool MPU9250::getSlave4WriteMode() {
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_SLV4_CTRL, MPU9250_I2C_SLV4_REG_DIS_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setSlave4WriteMode(bool mode) {
    SPIdev::writeBit(devAddr, MPU9250_RA_I2C_SLV4_CTRL, MPU9250_I2C_SLV4_REG_DIS_BIT, mode);
}
...
uint8_t MPU9250::getSlave4MasterDelay() {
    SPIdev::readBits(devAddr, MPU9250_RA_I2C_SLV4_CTRL, MPU9250_I2C_SLV4_MST_DLY_BIT, MPU9250_I2C_SLV4_MST_DLY_LENGTH, buffer);
    return buffer[0];
}
...
void MPU9250::setSlave4MasterDelay(uint8_t delay) {
    SPIdev::writeBits(devAddr, MPU9250_RA_I2C_SLV4_CTRL, MPU9250_I2C_SLV4_MST_DLY_BIT, MPU9250_I2C_SLV4_MST_DLY_LENGTH, delay);
}
...
uint8_t MPU9250::getSlate4InputByte() {
    SPIdev::readByte(devAddr, MPU9250_RA_I2C_SLV4_DI, buffer);
    return buffer[0];
}
 ...
 * into the MPU-9250. This is used as a way to pass an external interrupt
 * through the MPU-9250 to the host application processor. When set to 1, this
...
bool MPU9250::getPassthroughStatus() {
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_MST_STATUS, MPU9250_MST_PASS_THROUGH_BIT, buffer);
    return buffer[0];
}
...
bool MPU9250::getSlave4IsDone() {
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_MST_STATUS, MPU9250_MST_I2C_SLV4_DONE_BIT, buffer);
    return buffer[0];
}
...
bool MPU9250::getLostArbitration() {
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_MST_STATUS, MPU9250_MST_I2C_LOST_ARB_BIT, buffer);
    return buffer[0];
}
...
bool MPU9250::getSlave4Nack() {
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_MST_STATUS, MPU9250_MST_I2C_SLV4_NACK_BIT, buffer);
    return buffer[0];
}
...
bool MPU9250::getSlave3Nack() {
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_MST_STATUS, MPU9250_MST_I2C_SLV3_NACK_BIT, buffer);
    return buffer[0];
}
...
bool MPU9250::getSlave2Nack() {
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_MST_STATUS, MPU9250_MST_I2C_SLV2_NACK_BIT, buffer);
    return buffer[0];
}
...
bool MPU9250::getSlave1Nack() {
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_MST_STATUS, MPU9250_MST_I2C_SLV1_NACK_BIT, buffer);
    return buffer[0];
}
...
bool MPU9250::getSlave0Nack() {
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_MST_STATUS, MPU9250_MST_I2C_SLV0_NACK_BIT, buffer);
    return buffer[0];
}
...
bool MPU9250::getInterruptMode() {
    SPIdev::readBit(devAddr, MPU9250_RA_INT_PIN_CFG, MPU9250_INTCFG_INT_LEVEL_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setInterruptMode(bool mode) {
    SPIdev::writeBit(devAddr, MPU9250_RA_INT_PIN_CFG, MPU9250_INTCFG_INT_LEVEL_BIT, mode);
}
...
bool MPU9250::getInterruptDrive() {
    SPIdev::readBit(devAddr, MPU9250_RA_INT_PIN_CFG, MPU9250_INTCFG_INT_OPEN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setInterruptDrive(bool drive) {
    SPIdev::writeBit(devAddr, MPU9250_RA_INT_PIN_CFG, MPU9250_INTCFG_INT_OPEN_BIT, drive);
}
...
bool MPU9250::getInterruptLatch() {
    SPIdev::readBit(devAddr, MPU9250_RA_INT_PIN_CFG, MPU9250_INTCFG_LATCH_INT_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setInterruptLatch(bool latch) {
    SPIdev::writeBit(devAddr, MPU9250_RA_INT_PIN_CFG, MPU9250_INTCFG_LATCH_INT_EN_BIT, latch);
}
...
bool MPU9250::getInterruptLatchClear() {
    SPIdev::readBit(devAddr, MPU9250_RA_INT_PIN_CFG, MPU9250_INTCFG_INT_RD_CLEAR_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setInterruptLatchClear(bool clear) {
    SPIdev::writeBit(devAddr, MPU9250_RA_INT_PIN_CFG, MPU9250_INTCFG_INT_RD_CLEAR_BIT, clear);
}
...
bool MPU9250::getFSyncInterruptLevel() {
    SPIdev::readBit(devAddr, MPU9250_RA_INT_PIN_CFG, MPU9250_INTCFG_FSYNC_INT_LEVEL_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setFSyncInterruptLevel(bool level) {
    SPIdev::writeBit(devAddr, MPU9250_RA_INT_PIN_CFG, MPU9250_INTCFG_FSYNC_INT_LEVEL_BIT, level);
}
...
bool MPU9250::getFSyncInterruptEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_INT_PIN_CFG, MPU9250_INTCFG_FSYNC_INT_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setFSyncInterruptEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_INT_PIN_CFG, MPU9250_INTCFG_FSYNC_INT_EN_BIT, enabled);
}
/** Get I2C bypass enabled status.
 * When this bit is equal to 1 and I2C_MST_EN (Register 106 bit[5]) is equal to
 * 0, the host application processor will be able to directly access the
 * auxiliary I2C bus of the MPU-9250. When this bit is equal to 0, the host
 * application processor will not be able to directly access the auxiliary I2C
 * bus of the MPU-9250 regardless of the state of I2C_MST_EN (Register 106
 * bit[5]).
...
bool MPU9250::getI2CBypassEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_INT_PIN_CFG, MPU9250_INTCFG_I2C_BYPASS_EN_BIT, buffer);
    return buffer[0];
}
...
bool MPU9250::getIntFIFOBufferOverflowEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_INT_ENABLE, MPU9250_INTERRUPT_FIFO_OFLOW_BIT, buffer);
    return buffer[0];
}
...
bool MPU9250::getIntDataReadyEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_INT_ENABLE, MPU9250_INTERRUPT_DATA_RDY_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setIntDataReadyEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_INT_ENABLE, MPU9250_INTERRUPT_DATA_RDY_BIT, enabled);
}
...
bool MPU9250::getIntDataReadyStatus() {
    SPIdev::readBit(devAddr, MPU9250_RA_INT_STATUS, MPU9250_INTERRUPT_DATA_RDY_BIT, buffer);
    return buffer[0];
}
...
int16_t MPU9250::getAccelerationX() {
    SPIdev::readBytes(devAddr, MPU9250_RA_ACCEL_XOUT_H, 2, buffer);
...
int16_t MPU9250::getAccelerationY() {
    SPIdev::readBytes(devAddr, MPU9250_RA_ACCEL_YOUT_H, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
...
int16_t MPU9250::getAccelerationZ() {
    SPIdev::readBytes(devAddr, MPU9250_RA_ACCEL_ZOUT_H, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
...
int16_t MPU9250::getTemperature() {
    SPIdev::readBytes(devAddr, MPU9250_RA_TEMP_OUT_H, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
...
int16_t MPU9250::getRotationX() {
    SPIdev::readBytes(devAddr, MPU9250_RA_GYRO_XOUT_H, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
...
int16_t MPU9250::getRotationY() {
    SPIdev::readBytes(devAddr, MPU9250_RA_GYRO_YOUT_H, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
...
int16_t MPU9250::getRotationZ() {
    SPIdev::readBytes(devAddr, MPU9250_RA_GYRO_ZOUT_H, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
...
uint8_t MPU9250::getExternalSensorByte(int position) {
    SPIdev::readByte(devAddr, MPU9250_RA_EXT_SENS_DATA_00 + position, buffer);
    return buffer[0];
}
...
uint16_t MPU9250::getExternalSensorWord(int position) {
    SPIdev::readBytes(devAddr, MPU9250_RA_EXT_SENS_DATA_00 + position, 2, buffer);
...
uint32_t MPU9250::getExternalSensorDWord(int position) {
    SPIdev::readBytes(devAddr, MPU9250_RA_EXT_SENS_DATA_00 + position, 4, buffer);
...
void MPU9250::setSlaveOutputByte(uint8_t num, uint8_t data) {
    if (num > 3) return;
    SPIdev::writeByte(devAddr, MPU9250_RA_I2C_SLV0_DO + num, data);
}
...
bool MPU9250::getExternalShadowDelayEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_MST_DELAY_CTRL, MPU9250_DELAYCTRL_DELAY_ES_SHADOW_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setExternalShadowDelayEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_I2C_MST_DELAY_CTRL, MPU9250_DELAYCTRL_DELAY_ES_SHADOW_BIT, enabled);
}
...
bool MPU9250::getSlaveDelayEnabled(uint8_t num) {
    ...
    if (num > 4) return 0;
    SPIdev::readBit(devAddr, MPU9250_RA_I2C_MST_DELAY_CTRL, num, buffer);
    return buffer[0];
}
...
void MPU9250::setSlaveDelayEnabled(uint8_t num, bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_I2C_MST_DELAY_CTRL, num, enabled);
}
...
void MPU9250::resetGyroscopePath() {
    SPIdev::writeBit(devAddr, MPU9250_RA_SIGNAL_PATH_RESET, MPU9250_PATHRESET_GYRO_RESET_BIT, true);
}
...
void MPU9250::resetAccelerometerPath() {
    SPIdev::writeBit(devAddr, MPU9250_RA_SIGNAL_PATH_RESET, MPU9250_PATHRESET_ACCEL_RESET_BIT, true);
}
 ...
 * does not change unless the MPU-9250 is power cycled.
 * @return Current FIFO enabled status
 * @see MPU9250_RA_USER_CTRL
 * @see MPU9250_USERCTRL_FIFO_EN_BIT
 */
bool MPU9250::getFIFOEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_USER_CTRL, MPU9250_USERCTRL_FIFO_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setFIFOEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_USER_CTRL, MPU9250_USERCTRL_FIFO_EN_BIT, enabled);
}
/** Get I2C Master Mode enabled status.
 * When this mode is enabled, the MPU-9250 acts as the I2C Master to the
...
bool MPU9250::getI2CMasterModeEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_USER_CTRL, MPU9250_USERCTRL_I2C_MST_EN_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setI2CMasterModeEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_USER_CTRL, MPU9250_USERCTRL_I2C_MST_EN_BIT, enabled);
}
...
void MPU9250::switchSPIEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_USER_CTRL, MPU9250_USERCTRL_I2C_IF_DIS_BIT, enabled);
}
/** Reset the FIFO.
...
void MPU9250::resetFIFO() {
    SPIdev::writeBit(devAddr, MPU9250_RA_USER_CTRL, MPU9250_USERCTRL_FIFO_RESET_BIT, true);
}
...
void MPU9250::resetI2CMaster() {
    SPIdev::writeBit(devAddr, MPU9250_RA_USER_CTRL, MPU9250_USERCTRL_I2C_MST_RESET_BIT, true);
}
...
void MPU9250::resetSensors() {
    SPIdev::writeBit(devAddr, MPU9250_RA_USER_CTRL, MPU9250_USERCTRL_SIG_COND_RESET_BIT, true);
}
 ...
 */
void MPU9250::reset() {
    SPIdev::writeBit(devAddr, MPU9250_RA_PWR_MGMT_1, MPU9250_PWR1_DEVICE_RESET_BIT, true);
}
...
bool MPU9250::getSleepEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_PWR_MGMT_1, MPU9250_PWR1_SLEEP_BIT, buffer);
    return buffer[0];
}
...
void MPU9250::setSleepEnabled(bool enabled) {
    SPIdev::writeBit(devAddr, MPU9250_RA_PWR_MGMT_1, MPU9250_PWR1_SLEEP_BIT, enabled);
}
/** Get wake cycle enabled status.
 * When this bit is set to 1 and SLEEP is disabled, the MPU-9250 will cycle
...
bool MPU9250::getWakeCycleEnabled() {
    SPIdev::readBit(devAddr, MPU9250_RA_PWR_MGMT_1, MPU9250_PWR1_CYCLE_BIT, buffer);
    return buffer[0];
}
...
uint8_t MPU9250::getClockSource() {
    SPIdev::readBits(devAddr, MPU9250_RA_PWR_MGMT_1, MPU9250_PWR1_CLKSEL_BIT, MPU9250_PWR1_CLKSEL_LENGTH, buffer);
    return buffer[0];
}
/** Set clock source setting.
 * An internal 8MHz oscillator, gyroscope based clock, or external sources can
 * be selected as the MPU-9250 clock source. When the internal 8 MHz oscillator
...
uint16_t MPU9250::getFIFOCount() {
    SPIdev::readBytes(devAddr, MPU9250_RA_FIFO_COUNTH, 2, buffer);
    return (((uint16_t)buffer[0]) << 8) | buffer[1];
}
...
uint8_t MPU9250::getFIFOByte() {
    SPIdev::readByte(devAddr, MPU9250_RA_FIFO_R_W, buffer);
    return buffer[0];
}

void MPU9250::getFIFOBytes(uint8_t *data, uint8_t length) {
    SPIdev::readBytes(devAddr, MPU9250_RA_FIFO_R_W, length, data);
}
...
void MPU9250::setFIFOByte(uint8_t data) {
    SPIdev::writeByte(devAddr, MPU9250_RA_FIFO_R_W, data);
}
...
int16_t MPU9250::getXGyroOffset() {
    SPIdev::readBytes(devAddr, MPU9250_RA_XG_OFFS_H, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
void MPU9250::setXGyroOffset(int16_t offset) {
    SPIdev::writeWord(devAddr, MPU9250_RA_XG_OFFS_H, offset);
}

// YG_OFFS_* register

int16_t MPU9250::getYGyroOffset() {
    SPIdev::readBytes(devAddr, MPU9250_RA_YG_OFFS_H, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
void MPU9250::setYGyroOffset(int16_t offset) {
    SPIdev::writeWord(devAddr, MPU9250_RA_YG_OFFS_H, offset);
}

// ZG_OFFS_* register

int16_t MPU9250::getZGyroOffset() {
    SPIdev::readBytes(devAddr, MPU9250_RA_ZG_OFFS_H, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
